import logging
import os
import shutil   # 拥有许多文件（夹）操作的功能，包括复制、移动、重命名、删除等等
import json

import tensorflow as tf

from TemplateQA.conlleval import return_report
from TemplateQA.loader import get_seg_features
...
def clean(params):
    ...
    if os.path.isdir(params.ckpt_path):
        shutil.rmtree(params.ckpt_path)  # 会删除 path 路径文件夹，并且在这个文件夹里面的所有文件和子文件夹都会被删除
